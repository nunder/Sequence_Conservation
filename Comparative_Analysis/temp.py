...
class Alignment_Analysis:
    ...
    def __init__(self, analysis_type, alignment, num_states, non_cds_offset, group_id, fitted_parameters, project_dir, Alignment_HMM_Model, AE_HMM_Model, pairwise_fitted_parameters, master_fitted_parameters, seq_data):
        ...
        transition_probabilities, mutation_probabilities = AE_HMM_Model.alignment_hmm_model_inputs(master_fitted_parameters)
        observation_probabilities = AE_HMM_Model.calculate_observation_probs(mutation_probabilities, self.alignment.modified_sequence_list, alignment)
