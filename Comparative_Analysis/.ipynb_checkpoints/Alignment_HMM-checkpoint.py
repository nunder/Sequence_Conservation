...
class Alignment_HMM:
    ...
    def convert_alignment_hmm_to_parameters(transition_probabilities, mutation_probabilities):
    ...
    def EM_update_old(self, num_subsets, subset_num, params, offset, min_length, all_species = True, comparison_species = ''):
